...
var rpcContextRegisters = map[string]RPCContextTuple{
	...
	"TLMessagesReceivedQueue":              RPCContextTuple{"/mtproto.RPCMessages/messages_receivedQueue", func() interface{} { return new(VectorInt) }},
	"TLPhotosDeletePhotos":                 RPCContextTuple{"/mtproto.RPCPhotos/photos_deletePhotos", func() interface{} { return new(VectorInt) }},
