...
// select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = :user_id and deleted = 0 and user_message_box_id in (:idList) order by user_message_box_id desc
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectByMessageIdList(user_id int32, idList []int32) []dataobject.MessagesDO {
	var q = "select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = ? and deleted = 0 and user_message_box_id in (?) order by user_message_box_id desc"
...
// select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = :user_id and user_message_box_id = :user_message_box_id and deleted = 0 limit 1
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectByMessageId(user_id int32, user_message_box_id int32) *dataobject.MessagesDO {
	var query = "select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = ? and user_message_box_id = ? and deleted = 0 limit 1"
...
// select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = :user_id and peer_type = :peer_type and peer_id = :peer_id and user_message_box_id < :user_message_box_id and deleted = 0 order by user_message_box_id desc limit :limit
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectBackwardByPeerOffsetLimit(user_id int32, peer_type int8, peer_id int32, user_message_box_id int32, limit int32) []dataobject.MessagesDO {
	var query = "select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = ? and peer_type = ? and peer_id = ? and user_message_box_id < ? and deleted = 0 order by user_message_box_id desc limit ?"
...
func (dao *MessagesDAO) SelectBackwardByPeerUserOffsetLimit(user_id int32, peer_id int32, peer_type int8, user_message_box_id int32, limit int32) []dataobject.MessagesDO {
	var query = "select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = ? and ((sender_user_id = ? and peer_id = ?) or (sender_user_id = ? and peer_id = ?)) and peer_type = ? and user_message_box_id < ? and deleted = 0 order by user_message_box_id desc limit ?"
...
// select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = :user_id and peer_type = :peer_type and peer_id = :peer_id and user_message_box_id >= :user_message_box_id and deleted = 0 order by user_message_box_id asc limit :limit
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectForwardByPeerOffsetLimit(user_id int32, peer_type int8, peer_id int32, user_message_box_id int32, limit int32) []dataobject.MessagesDO {
	var query = "select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = ? and peer_type = ? and peer_id = ? and user_message_box_id >= ? and deleted = 0 order by user_message_box_id asc limit ?"
	rows, err := dao.db.Queryx(query, user_id, peer_type, peer_id, user_message_box_id, limit)
...
func (dao *MessagesDAO) SelectForwardByPeerUserOffsetLimit(user_id int32, peer_id int32, peer_type int8, user_message_box_id int32, limit int32) []dataobject.MessagesDO {
	var query = "select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id = ? and ((sender_user_id = ? and peer_id = ?) or (sender_user_id = ? and peer_id = ?)) and peer_type = ? and user_message_box_id >= ? and deleted = 0 order by user_message_box_id asc limit ?"
	rows, err := dao.db.Queryx(query, user_id, user_id, peer_id, peer_id, user_id, peer_type, user_message_box_id, limit)
...
// select user_message_box_id, message_box_type from messages where user_id = :peerId and dialog_message_id = (select dialog_message_id from messages where user_id = :user_id and user_message_box_id = :user_message_box_id and deleted = 0 limit 1)
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectPeerMessageId(peerId int32, user_id int32, user_message_box_id int32) *dataobject.MessagesDO {
	var query = "select user_message_box_id, message_box_type from messages where user_id = ? and dialog_message_id = (select dialog_message_id from messages where user_id = ? and user_message_box_id = ? and deleted = 0 limit 1)"
...
// select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, dialog_message_id, message_type from messages where user_id != :user_id and dialog_message_id in (select dialog_message_id from messages where user_id = :user_id and user_message_box_id in (:idList)) and deleted = 0
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectPeerDialogMessageIdList(user_id int32, idList []int32) []dataobject.MessagesDO {
	var q = "select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, dialog_message_id, message_type from messages where user_id != ? and dialog_message_id in (select dialog_message_id from messages where user_id = ? and user_message_box_id in (?)) and deleted = 0"
...
// select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where dialog_message_id = (select dialog_message_id from messages where user_id = :user_id and user_message_box_id = :user_message_box_id) and deleted = 0
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectDialogMessageListByMessageId(user_id int32, user_message_box_id int32) []dataobject.MessagesDO {
	var query = "select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where dialog_message_id = (select dialog_message_id from messages where user_id = ? and user_message_box_id = ?) and deleted = 0"
	rows, err := dao.db.Queryx(query, user_id, user_message_box_id)
...
// select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id != :user_id and dialog_message_id = (select dialog_message_id from messages where user_id = :user_id and user_message_box_id = :user_message_box_id) and deleted = 0
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectPeerDialogMessageListByMessageId(user_id int32, user_message_box_id int32) []dataobject.MessagesDO {
	var query = "select user_id, user_message_box_id, dialog_message_id, sender_user_id, message_box_type, peer_type, peer_id, message_type, message_data, date2 from messages where user_id != ? and dialog_message_id = (select dialog_message_id from messages where user_id = ? and user_message_box_id = ?) and deleted = 0"
...
func (dao *MessagesDAO) SelectLastTwoMessageId(user_id int32) *dataobject.MessagesDO {
	var query = "select user_message_box_id from messages where user_id = ? order by user_message_box_id desc limit 2"
...
// select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, dialog_message_id, message_type from messages where user_id = :user_id and user_message_box_id in (:idList) and deleted = 0
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectDialogsByMessageIdList(user_id int32, idList []int32) []dataobject.MessagesDO {
	var q = "select user_id, user_message_box_id, sender_user_id, message_box_type, peer_type, peer_id, dialog_message_id, message_type from messages where user_id = ? and user_message_box_id in (?) and deleted = 0"
	query, a, err := sqlx.In(q, user_id, idList)
	rows, err := dao.db.Queryx(query, a...)
...
func (dao *MessagesDAO) DeleteMessagesByMessageIdList(user_id int32, idList []int32) int64 {
	var q = "update messages set deleted = 1 where user_id = ? and user_message_box_id in (?) and deleted = 0"
	query, a, err := sqlx.In(q, user_id, idList)
...
func (dao *MessagesDAO) UpdateMessagesData(message_data string, user_id int32, user_message_box_id int32) int64 {
	var query = "update messages set message_data = ? where user_id = ? and user_message_box_id = ? and deleted = 0"
...
// select user_message_box_id from messages where user_id = :user_id and ((sender_user_id = :user_id and peer_id = :peer_id) or (sender_user_id = :peer_id and peer_id = :user_id)) and peer_type = :peer_type and deleted = 0
// TODO(@benqi): sqlmap
func (dao *MessagesDAO) SelectDialogMessageIdList(user_id int32, peer_id int32, peer_type int8) []dataobject.MessagesDO {
	var query = "select user_message_box_id from messages where user_id = ? and ((sender_user_id = ? and peer_id = ?) or (sender_user_id = ? and peer_id = ?)) and peer_type = ? and deleted = 0"
