...
func GetChatFull(chatId int32) (*mtproto.TLChatFull) {
	chatFull := mtproto.NewTLChatFull()

	chatFull.SetId(chatId)
	chatFull.SetParticipants(GetChatParticipants(chatId).To_ChatParticipants())
...
func GetChatParticipants(chatId int32) (*mtproto.TLChatParticipants) {
...
func GetChatsByIDList(idList []int32) (chats []*mtproto.TLChat) {
