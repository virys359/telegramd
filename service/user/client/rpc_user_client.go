...
func rpcUserClientInstance() UserApi {
...
func (c *rpcUserClient) GetUserByID(id int32) (*mtproto.User, error) {
	return nil, nil
}

func (c *rpcUserClient) GetUserListByIDList(idList []int32) ([]*mtproto.User, error) {
	return nil, nil
}
