...
func (*Error_Data) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*TLError) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*Null_Data) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
...
func (*Null) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{4} }
...
func (*TLNull) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{5} }
...
func (*Bool_Data) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{6} }
...
func (*Bool) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{7} }
...
func (*TLBoolFalse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{8} }
...
func (*TLBoolTrue) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{9} }
...
func (*True_Data) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{10} }
...
func (*True) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{11} }
...
func (*TLTrue) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{12} }
...
func init() { proto.RegisterFile("schema.tl.core_types.proto", fileDescriptor3) }
